...
PLAN_LIMITS = {
    ...
    "starter": PlanLimits(
        ...
        monthly_page_quota=_read_int_env("STARTER_MONTHLY_PAGE_QUOTA", 100),
    ...
    "pro": PlanLimits(
        ...
        monthly_page_quota=_read_int_env("PRO_MONTHLY_PAGE_QUOTA", 500),
        free_preview_pages=0,
    ),
    "power": PlanLimits(
        plan="power",
        ...
        monthly_page_quota=_read_int_env("POWER_MONTHLY_PAGE_QUOTA", 3000),
        free_preview_pages=0,
    ),
}
